...
Write-Host "Full screenshot saved: $fullPath"

# 裁剪右下角区域 (窗口位置)
# 窗口宽度约380，高度约550，位置在右下角距边缘20px
$x = $screenWidth - 420
$y = 20
$width = 400
$height = 600
...
Write-Host "Main window screenshot saved: $croppedPath"
...
Write-Host ""
Write-Host "Done! Please check the screenshot files."
